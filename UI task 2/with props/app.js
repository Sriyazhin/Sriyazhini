  ...
  return (
    <div className='full'>
      ...
      <div className='forcards'>
        ...
        <Planning />
        <Design /> */}
        <Building divisionName='analysis' photoName={require('./assets/images/analysis.webp')} cardName='ANALYSIS' />
        <Building divisionName='planning' photoName={require('./assets/images/planning.jpg')} cardName='PLANNING' />
        <Building divisionName='design' photoName={require('./assets/images/design.avif')} cardName='DESIGN' />
        <Building divisionName='building' photoName={require('./assets/images/building.webp')} cardName='BUILDING' />
      </div>
